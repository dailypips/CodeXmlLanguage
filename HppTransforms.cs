...
namespace QuantKit
{
    public class CSharpToHpp : IAstTransform
    {
        ...
        IEnumerable<IAstTransform> GetTransforms()
        {
            ...
            yield return new ReplaceStringToQString();
            yield return new ReplaceDateTimeTypeToQDateTime();
            yield return new ReplaceByteToUnsignedChar();
            //yield return new RemoveNullCtor();
        ...
        class ReplaceByteToUnsignedChar : DepthFirstAstVisitor, IAstTransform
        {
            public void Run(AstNode compilationUnit)
            {
                compilationUnit.AcceptVisitor(this);
            ...
            public override void VisitPrimitiveType(PrimitiveType primitiveType)
            {
                ...
                if (primitiveType.Keyword == "byte")
                {
                    primitiveType.Keyword = "unsigned char";
                }
            }
        }

        class ReplaceStringToQString : DepthFirstAstVisitor, IAstTransform
        {
            public void Run(AstNode compilationUnit)
            {
                compilationUnit.AcceptVisitor(this);
            ...
            public override void VisitPrimitiveType(PrimitiveType primitiveType)
            {
                ...
                if (primitiveType.Keyword == "string")
                {
                    var qstring = new SimpleType();
                    qstring.Identifier = "QString";
                    primitiveType.ReplaceWith(qstring);
                }
            }
        }

        class ReplaceDateTimeTypeToQDateTime : DepthFirstAstVisitor, IAstTransform
        {
            public void Run(AstNode compilationUnit)
            {
                compilationUnit.AcceptVisitor(this);
            ...
            public override void VisitSimpleType(SimpleType simpleType)
            {
                ...
                {
                    simpleType.Identifier = "QDateTime";
                }
            }
        }
        ...
        class RemoveNullCtor : DepthFirstAstVisitor, IAstTransform
        {
            public void Run(AstNode compilationUnit)
            {
                compilationUnit.AcceptVisitor(this);
            ...
            public override void VisitConstructorDeclaration(ConstructorDeclaration constructorDeclaration)
            {
                ...
                var slist = constructorDeclaration.Descendants.OfType<ExpressionStatement>().ToList();
                if (slist.Count() == 0)
                {
                    constructorDeclaration.Remove();
                    return;
                ...
                {
                    if (item.GetText().Contains("base..ctor"))
                    {
                        foundbasector = true;
                        break;
                    }
                ...
                if (foundbasector)
                {
                    ...
                    {
                        if (!slist[i].GetText().Contains("base..ctor"))
                            slist[i].Remove();
                        else
                        {
                            slist[i].Remove();
        ...
        class NullableChecks : DepthFirstAstVisitor, IAstTransform
        {
            ...
            public override void VisitMemberReferenceExpression(MemberReferenceExpression memberReferenceExpression)
            {
                ...
                {
                    var t = Helpers.GetTypeRef(memberReferenceExpression.Target);
        ...
        class PassArraysAsEnumerables : DepthFirstAstVisitor, IAstTransform
        {
            ...
            public override void VisitVariableInitializer(VariableInitializer variableInitializer)
            {
                ...
                var tra = Helpers.GetTypeRef(variableInitializer.Initializer);
                if (tra == null || !tra.IsArray)
                    return;
        ...
        class InlineEnumMethods : DepthFirstAstVisitor, IAstTransform
        {
            ...
            public override void VisitInvocationExpression(InvocationExpression invocationExpression)
            {
                ...
                var td = Helpers.GetTypeDef(target);
        ...
        class CharsToNumbers : DepthFirstAstVisitor, IAstTransform
        {
            ...
            public override void VisitIndexerExpression(IndexerExpression indexerExpression)
            {
                ...
                var t = Helpers.GetTypeRef(indexerExpression.Target);
        ...
        class FixGenericsThatUseObject : DepthFirstAstVisitor, IAstTransform
        {
            ...
            public override void VisitMethodDeclaration(MethodDeclaration methodDeclaration)
            {
                ...
                var q = from mr in methodDeclaration.Body.Descendants.OfType<MemberReferenceExpression>()
                        ...
                        let tr = Helpers.GetTypeRef(mr.Target)
        ...
        class BitwiseOrToConditionalForBooleans : DepthFirstAstVisitor, IAstTransform
        {
            ...
            public override void VisitBinaryOperatorExpression(BinaryOperatorExpression binaryOperatorExpression)
            {
                ...
                var leftT = Helpers.GetTypeRef(binaryOperatorExpression.Left);
        ...
        class ExpandIndexers : IAstTransform
        {
            ...
            class EI : DepthFirstAstVisitor
            {
                ...
                public override void VisitIndexerExpression(IndexerExpression indexerExpression)
                {
                    ...
                    var tr = Helpers.GetTypeRef(indexerExpression.Target);
        ...
        class ExpandOperators : DepthFirstAstVisitor, IAstTransform
        {
            ...
            public override void VisitBinaryOperatorExpression(BinaryOperatorExpression binaryOperatorExpression)
            {
                ...
                var leftT = Helpers.GetTypeDef(binaryOperatorExpression.Left);
        ...
        class Renames : DepthFirstAstVisitor, IAstTransform
        {
            ...
            public override void VisitMemberReferenceExpression(MemberReferenceExpression memberReferenceExpression)
            {
                ...
                if (memberReferenceExpression.MemberName == "Length")
                {
                    ...
                    var tt = Helpers.GetTargetTypeRef(memberReferenceExpression);
        ...
        {
            return IsDelegate(Helpers.GetTypeDef(type));
        }
